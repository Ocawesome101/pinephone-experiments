...
local label2 = ui.label.new(1, 100, wd, ht, "This is a darker page.  Try using the back button on the navigation bar.  Try typing on the keyboard.", 0xFFFFFF, UI_SCALE)
local button = ui.button.new(1, 100, wd, 88, "Tap Me!", 0xFFFFFF, 0, UI_SCALE)

local tbox = ui.textbox.new(1, 88, wd, 88, 0, 0xFFFFFF)
...
page2.children[#page2.children + 1] = tbox
